...
def export_orders_csv(request):
    ...
    orders = (
        ServiceOrder.objects.select_related("device__customer", "assigned_to")
    ...
    def iter_rows():
        ...
        for order in orders:
            customer = order.device.customer if order.device_id else None
...
def export_payments_csv(request):
    ...
    start_dt, end_dt = _build_range(start, end)
    payments = (
        Payment.objects.select_related("order__device__customer", "author")
